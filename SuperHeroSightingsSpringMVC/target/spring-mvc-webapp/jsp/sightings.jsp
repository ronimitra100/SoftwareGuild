                ...
                <div class="col-md-5">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="createSighting">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="heroId" placeholder="ID of Superperson"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="add-location" class="col-md-4 control-label">Location ID:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="locationId" placeholder="ID of Sighting Location"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="add-sighting-time" class="col-md-4 control-label">Sighting Date:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="sightingTime" placeholder="Date of Sighting in YYYY-MM-DD format"/>
                            </div>
                        </div>
