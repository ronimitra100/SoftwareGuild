...
function getWeatherForecast(data, units) {
  ...
  for (i = 0; i < 5; i++) {
    ...
    var overallWeather = data.weather[0].main;

    weatherForecast += weatherForecast("<divclass=\"col-xs-2\"><ulstyle=\"list-style:none;text-align:center\"><li>" + concernedDay + "<\/li>" +
      "<li><img src=\"http:\/\/openweathermap.org\/img\/w\/" + icon + ".png\"> "+ overallWeather+ "<\/li><li>" + highestTemp + " " + lowestTemp + "<\/li><\/ul><\/div>");
  }
