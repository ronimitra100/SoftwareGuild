        ...
        | <a href="<c:url value="/j_spring_security_logout" />" > Logout</a>
                    ...
                    <sf:form class="form-horizontal" role="form" method="POST" modelAttribute="contact" action="editContact">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" name="firstName" path="firstName" placeholder="First Name"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" name="lastName" path="lastName" placeholder="Last Name"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" name="company" path="company" placeholder="Company"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" name="email" path="email" placeholder="Email"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" name="phone" path="phone" placeholder="Phone"/>
