...
ALTER TABLE superhero_sightings.superhero_organization_affiliations ADD CONSTRAINT UK_HERO_ORG UNIQUE(hero_id,org_id);
...
ALTER TABLE superhero_sightings.sightings ADD CONSTRAINT UK_HERO_LOCATION_DATE UNIQUE(hero_id,location_id,sighting_time);
-- -----------------------------------------------------
...
ALTER TABLE superhero_sightings_test.superhero_organization_affiliations ADD CONSTRAINT UK_HERO_ORG UNIQUE(hero_id,org_id);
...
ALTER TABLE superhero_sightings_test.sightings ADD CONSTRAINT UK_HERO_LOCATION_DATE UNIQUE(hero_id,location_id,sighting_time);
