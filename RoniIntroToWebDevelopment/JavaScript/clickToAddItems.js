...
function validateItems(){
	...
	if (num1=="" || isNaN(num1)){
		...
		document.form["numberFun"]["num1"].parentElement.className ="form-group has-error";
		document.form["numberFun"]["num1"].focus();
		return false;
	}
	if (num2=="" || isNaN(num2)){
		alert("Num2 must be filled with a number");
		document.form["numberFun"]["num2"].parentElement.className ="form-group has-error";
		document.form["numberFun"]["num2"].focus();
		return false;
	}
