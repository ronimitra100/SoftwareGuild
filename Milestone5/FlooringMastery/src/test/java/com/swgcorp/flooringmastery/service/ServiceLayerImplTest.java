...
public class ServiceLayerImplTest {
    ...
    @Test
    public void testAddOrderForHappyPathCase() throws Exception {
        ...
        System.out.println("Exp: " + order1.toString());
        //System.out.println("Actual: " + service.addOrder("Roni1 Mitra1", "MI", "Carpet", new BigDecimal("100.00")));
        
        assertEquals(order1,service.addOrder("Roni1 Mitra1", "MI", "Carpet", new BigDecimal("100.00")));
    }
    
  @Test
    public void testDisplayAllOrdersPlacedOnAGivenDate() throws Exception {
        List<Order> listOfOrders = service.displayAllOrdersPlacedOnAGivenDate("12312018");
        assertEquals(2, listOfOrders.size());
    }

    @Test
    public void testEditOrderWithNewValidValuesForAllAttributes() throws Exception {
