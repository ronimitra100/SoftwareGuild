...
public class ContactListDaoTest {
    ...
    public void testGetAllContacts() {
        ...
        nc2.setFirstName("Mary");
        nc.setLastName("Poppins");
        nc.setCompany("Charles Schwab");
        nc.setEmail("mary@poppins.com");
        nc.setPhone("555-666-777");
        dao.addContact(nc2);
