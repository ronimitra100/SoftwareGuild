...
<html>
    ...
    <body>
        <div class="container zoomed-and-centered">
            ...
            <div>
                <h1 class="h1">Vending Machine</h1>
                <hr/>
                        ...
                        <div id="user-interaction-forms" class="col-lg-4 col-lg-30">
                            <form id="make-a-deposit-form" class="form-horizontal" action="addMoney" method="POST" >
                                <div class="form-group ">
                                    <div class="col-lg-8 col-lg-offset-2 ">
                                        <h3><label for="deposit" >Total $ In</label></h3>
                                        <input  class="form-control" id="deposit" value="${currentDeposit}" readonly />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                            ...
                            <form id="make-purchase-form"  class="form-horizontal" action="makePurchase" method="POST">
                                <div class="form-group">
                                    ...
                                    <input  value="${message}" class="form-control" id="message-box" readonly/>
                                </div>
                                <div class="form-group">
                                    <label for="item-id" class="col-lg-4 control-label enlarged-font">
                                        Item:
                                    </label>
                                    <div class="col-lg-8">
                                        <input type="submit" class="form-control" id="item-id" value="${itemSelection}">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <hr/>
                            <form id="get-change-form"  class="form-horizontal" action="getChange" method="GET">
                                <div class="form-group">
                                    <h3><label for="change">Change</label></h3>
                                    <input  value="${changeInfo}" class="form-control col-lg-offset-2" id="change-box"  readonly>
                                </div>
                                <div class="form-group">
